 ...
 * @return unsigned long long Integer value corresponding to the contents of str on success. If the converted value falls
 *  out of range of corresponding return type, range error occurs and ULLONG_MAX is returned. If no
